...
test_that("check working example date and Gestage distribution", {
  mt <- tibble::tibble(
  ...
  #see Overview
  expect_true(seeOverview[1,2]=="2010-01-12")
  expect_true(seeOverview[2,2]=="2015-07-22")
  expect_true(seeOverview[3,2]=="2010-03-02")
  expect_true(seeOverview[4,2]=="2016-02-07")
  expect_true(seeOverview[5,2]=="49")
  expect_true(seeOverview[26,2]=="300")
