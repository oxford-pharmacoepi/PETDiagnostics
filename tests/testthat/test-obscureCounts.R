test_that("check working example 1) < min cell count 2) and not 0 obscured", {
  ...
  table <- tibble::tibble(
    ...
    proportionInPercentage = c(10.0,10.0,40.0,13.0,12.0,5.0,0.0,0.0,2.0),
  ...
  table <- tibble::tibble(
    ...
    count = c(0,0,6,2,0),
    proportionInPercentage = c(0.0,0.0,5.5,2.2,0.0),
  ...
  table <- tibble::tibble(
    ...
    proportionInPercentage = c(50.0,50.0,0.0,4.0,96.0),
  ...
  table <- tibble::tibble(
   ...
   count = c(30,66,4),
   proportionInPercentage = c(30.0,66.0,4.0),
   total = c(100,100,100)
 )
  ...
  table <- tibble::tibble(
    ...
    proportionInPercentage = c(4.0,60.0,36.0,3.0,87.0,20.0),
