test_that("check working example 1) each count 2) adds up to total", {
  ...
  expect_true(seeOutMode[1,2] + seeOutMode[2,2] + seeOutMode[3,2] == seeOutMode[1,4])
  expect_true(seeOutMode[1,2] + seeOutMode[2,2] + seeOutMode[3,2] == seeOutMode[2,4])
  expect_true(seeOutMode[1,2] + seeOutMode[2,2] + seeOutMode[3,2] == seeOutMode[3,4])
