...
# or use your own cdm connection
## you will have to add the table to the cdm as follows:
## replace the YOURSCHEMA to be your schema name, and the PREGNANCYTABLENAME to be your motherTable name
## cdm$motherTable <- tbl(db,dbplyr::in_schema("YOURSCHEMA","PREGNANCYTABLENAME"))
